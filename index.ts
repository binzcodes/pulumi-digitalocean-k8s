...
const appReplicaCount = config.getNumber("appReplicaCount") || 2;
const domainName = config.get("domainName"); // 'lab.rbi.nz
        ...
        spec: {
          containers: [
            ...
            },
            {
              ...
              args: [domainName ? "--domain" : '', domainName ?? ''],
            },
          ],
        },
      },
